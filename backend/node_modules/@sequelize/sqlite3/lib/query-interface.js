...
var import_deprecations = require("@sequelize/core/_non-semver-use-at-your-own-risk_/utils/deprecations.js");
...
class SqliteQueryInterface extends import_core.AbstractQueryInterface {
  ...
  async describeTable(tableName, options) {
    ...
    try {
      const data = await this.sequelize.queryRaw(sql, {
        ...options,
        type: import_core.QueryTypes.DESCRIBE
      });
      ...
      if (error instanceof import_core.BaseError && (0, import_check.isErrorWithStringCode)(error.cause) && error.cause.code === "ER_NO_SUCH_TABLE") {
        throw new Error(
          `No description found for table ${table.tableName}${table.schema ? ` in schema ${table.schema}` : ""}. Check the table name and schema; remember, they _are_ case sensitive.`
        );
      }
