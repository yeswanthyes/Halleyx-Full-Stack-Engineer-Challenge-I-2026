...
var import_format = require("@sequelize/core/_non-semver-use-at-your-own-risk_/utils/format.js");
...
class SqliteQueryGenerator extends import_query_generator_typescript_internal.SqliteQueryGeneratorTypeScript {
  ...
  updateQuery(tableName, attrValueHash, where, options, attributes) {
    ...
    let bind;
    let bindParam;
    const parameterStyle = options?.parameterStyle ?? import_core.ParameterStyle.BIND;
    if (parameterStyle === import_core.ParameterStyle.BIND) {
  ...
  attributesToSQL(attributes, options) {
    ...
    for (const name in attributes) {
      ...
      if ((0, import_isObject.default)(attribute)) {
